$(function(){
	...
	$('.house1').on('click',function(){//互联网机房
		var url = "http://156.8.11.20/vmdb-sso/external/operation/poclogin?loginCode=admin&targetUrl=http://156.8.11.20/tarsier-vmdb/dcvWeb/dcv/home.html?ID=100000000000001#func=uinv.u3d.funcSet.setSelectionRootObjByBID('3F非涉密机房')";
	...
	$('.house4').on('click',function(){//备份机房
		var url = "http://156.8.11.20/vmdb-sso/external/operation/poclogin?loginCode=admin&targetUrl=http://156.8.11.20/tarsier-vmdb/dcvWeb/dcv/home.html?ID=100000000000001#func=uinv.u3d.funcSet.setSelectionRootObjByBID('吉莲3F屏蔽机房')";
		$("body").show().html('<iframe frameborder="0" scrolling="no" src="' + url + '" width="100%"' +
			    ' height="100%"></iframe>');
	})
