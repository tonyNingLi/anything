$(function(){
	...
	$.ajax({
	    ...
	    success: function (res) {
			...
			var zdData2 = $(".flightShowUl").flightShow(list);
			zdData2.autoRefresh();
	    }
	})
	...
	$('.assetsBlock').on('click',function(){//资产信息二级页面
		var url = window.location.origin+"/SjwProject/zcgl/zcglSelectOneJump";
		$("body").show().html('<iframe frameborder="0" scrolling="no" src="' + getZcLoginUrl() + '" width="100%"' +
			    ' height="100%"></iframe>');
	})
