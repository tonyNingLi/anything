...
//java -jar demo-1023-3-SNAPSHOT.jar
...
$(function () {
    ...
    WebVideoCtrl.I_InitPlugin(500, 300, {
        ...
        cbInitPluginComplete: function () {
			...
			//WebVideoCtrl.I_InsertOBJECTPlugin("demo");
    ...
    //clickLogin(jsdd_config01);
	//clickLogin(jsdd_config02);
	for(var i=0,l=data.length;i<l;i++){
		let itemData=data[i];
		
		let tempI=i;
		/*setTimeout(function(){
			clickLogin(itemData,tempI);//循环登录
		},1000);*/
		clickLogin(itemData,i);//循环登录
	}
...
// 登录
function clickLogin(param,indexI) {
...
// 开始预览
function clickStartRealPlay(indexI,iStreamType) {
    ...
    var startRealPlay = function () {
        WebVideoCtrl.I_StartRealPlay(data[indexI].szIP, {//szDeviceIdentify
			iWndIndex:indexI//后加的
            /*iRtspPort: iRtspPort,
