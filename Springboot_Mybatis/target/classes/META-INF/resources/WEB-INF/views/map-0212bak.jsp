...
<div id="lbt">
	<div class="box2">
		...
		<div class="box2-right">
			<div><img src="<%=request.getContextPath()%>/resources/map/img/on.png" /><span>在线：0</span></div>
			<div><img src="<%=request.getContextPath()%>/resources/map/img/out.png" /><span>离线：40</span></div>
			<div><img src="<%=request.getContextPath()%>/resources/map/img/xgz.png" /><span>故障：0</span></div>
		</div>
		<div class="clear"></div>
	</div>
	<div class="box2">
		...
		<div class="box2-right">
			<div><img src="<%=request.getContextPath()%>/resources/map/img/on.png" /><span>在线：0</span></div>
			<div><img src="<%=request.getContextPath()%>/resources/map/img/out.png" /><span>离线：35</span></div>
			<div><img src="<%=request.getContextPath()%>/resources/map/img/xgz.png" /><span>故障：0</span></div>
		</div>
		<div class="clear"></div>
	</div>
	<div class="box2">
		...
		<div class="box2-right">
			<div><img src="<%=request.getContextPath()%>/resources/map/img/on.png" /><span>在线：0</span></div>
			<div><img src="<%=request.getContextPath()%>/resources/map/img/out.png" /><span>离线：25</span></div>
			<div><img src="<%=request.getContextPath()%>/resources/map/img/xgz.png" /><span>故障：0</span></div>
		</div>
		<div class="clear"></div>
	</div>
