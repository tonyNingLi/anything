...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/sences/css/index.css" />
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/sences/css/animate.css"/>
		<title>感知系统整合</title>
	</head>
	<body>
		<div class="wrap" id='app' @click='this.clearFloatBox'>
		...
		<script type="text/javascript">
			let app = new Vue({
			    el: '#app',
			    data: {
			        contentShowFlagList: [true, false, false, false],
			        contentItem1List: [],
			        contentItem2List: [],
			        contentItem3List: [],
			        contentItem4List: [],
			    ...
			    methods: {
			        ...
			        setContent1Data: function () { //设置content1中的数据
			            this.contentItem1List.length = 0;
			            let list = [
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                that.contentItem1List =  list;
                            }
                        })
			            console.log('contentItem1List',this.contentItem1List);
			        },
			        setContent2Data: function () { //设置content2中的数据
			            this.contentItem2List.length = 0;
			            this.contentItem2List = [
			                {
			                    id: 1,
			                    name: '驻省委办公厅纪检监察组',
			                    isRed: false,
			        ...
			        setContent3Data: function () { //设置content3中的数据
			            this.contentItem3List.length = 0;
			            this.contentItem3List = [
			        ...
			        setContent4Data: function () { //设置content4中的数据
			            this.contentItem4List.length = 0;
			            this.contentItem4List = [
			                {
			                    id: 1,
			                    name: '吉林银行股份有限公司',
			                    isRed: false,
			        ...
			        cutTab: function (index) { //切换按钮
			            ...
			            switch (index) {
			                case 0:
			                    this.setContent1Data();
			                    break;
			                case 1:
			                    this.setContent2Data();
			                    break;
			                case 2:
			                    this.setContent3Data();
			                    break;
			                case 3:
			                    this.setContent4Data();
			                    break;
			            }
			        },
